    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.SetTwoFactorSuccess ? "Dwu etapowa autentykacja została ustawiona."
                : message == ManageMessageId.Error ? "Wystąpił błąd."
                : message == ManageMessageId.AddPhoneSuccess ? "Dodan twój numer telefonu."
                : message == ManageMessageId.RemovePhoneSuccess ? "Usunięto twój numer telefonu."
                : "";
        ...
        public async Task<ActionResult> VerifyPhoneNumber(VerifyPhoneNumberViewModel model)
        {
            ...
            ModelState.AddModelError("", "Błąd przy weryfikacji telefonu.");
            return View(model);
        }
        ...
        public async Task<ActionResult> ChangeInformation(ChangeInformationViewModel model)
        {
            ...
            changedUser.Name = model.Name;
            changedUser.Surname = model.Surname;
            changedUser.BirthDate = model.BirthDate;
            await UserManager.UpdateAsync(changedUser);
